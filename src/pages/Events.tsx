...
import { MobileCalendarView } from '@/components/events/MobileCalendarView';
...
export const Events = () => {
  ...
  const EventsContent = () => {
    ...
    return (
      ...
      {/* Controls Bar - Hidden on mobile for calendar view */}
      ...
      {/* Mobile Calendar View Toggle - Only show on mobile */}
      {isMobile && (
          ...
          <div className="flex items-center justify-center">
            <div className="flex items-center bg-background border border-border rounded-md">
              <Button
                ...
                size="sm"
                onClick={() => setViewMode('list')}
                className={`rounded-r-none border-r text-xs px-3 ${viewMode === 'list' ? 'bg-primary text-primary-foreground' : 'hover:bg-accent'}`}
              >
              ...
              <Button
                ...
                size="sm"
                onClick={() => setViewMode('calendar')}
                className={`rounded-l-none text-xs px-3 ${viewMode === 'calendar' ? 'bg-primary text-primary-foreground' : 'hover:bg-accent'}`}
              >
