  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <div 
          className="h-10 flex items-center px-3 bg-muted rounded-md text-sm font-medium cursor-pointer hover:bg-muted/80 transition-colors border border-transparent hover:border-border"
