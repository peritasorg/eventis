...
BEGIN
    FOR tenant_record IN SELECT id FROM public.tenants WHERE active = true
    LOOP
        INSERT INTO public.event_time_slots (tenant_id, label, start_time, end_time, sort_order) VALUES
        (tenant_record.id, 'Morning', '09:00'::time, '12:00'::time, 1),
        (tenant_record.id, 'Afternoon', '12:00'::time, '17:00'::time, 2),
        (tenant_record.id, 'Evening', '17:00'::time, '22:00'::time, 3),
        (tenant_record.id, 'Night', '22:00'::time, '02:00'::time, 4);
    END LOOP;
END $$;
